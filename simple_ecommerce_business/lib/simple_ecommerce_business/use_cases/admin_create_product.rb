...
require 'simple_ecommerce_business/entities/product'

module SimpleEcommerceBusiness
  module UseCases
    class AdminCreateProduct < CleanArchitecture::UseCases::AbstractUseCase # rubocop:disable Style/Documentation
      contract do
        option :product_gateway
